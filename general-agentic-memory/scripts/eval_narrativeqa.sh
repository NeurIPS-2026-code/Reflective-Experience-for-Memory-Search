...
python3 general-agentic-memory/eval/narrativeqa_test.py \
    --data-dir general-agentic-memory/data/narrativeqa \
    --split test \
    --outdir $outputdir \
    --start-idx 0 \
    --end-idx 300 \
