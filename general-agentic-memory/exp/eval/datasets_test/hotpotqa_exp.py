...
# 使用我们的research_exp模块
sys.path.insert(0, '/NAS/wangxy/general-agentic-memory')
...
# 从环境变量读取配置
hotpotqa_data = os.environ.get('HOTPOTQA_DATA')
print(f"已读取 hotpotqa_data: {hotpotqa_data}")
...
bge_path = "/NAS/wangxy/BAAI/bge-m3"
